...
Realife_Kp=read.csv("Isolate_Cluster_8_1.csv",row.names = 1)
#head(Realife_Kp)
...
plot(my_tree)
# read barcodes
barcodesfilename="Isolate_Cluster_8_1.csv"
...
output_file <- "C:\\Users\\kadau6472\\OneDrive - University of Bergen\\sorted_pairs2.txt"
